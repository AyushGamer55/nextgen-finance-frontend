        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {actionButtons.map(({ key, label, Icon, color }) => (
            <button
              ...
              className={`flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background ${color}`}
            >
